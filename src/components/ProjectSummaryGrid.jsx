        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {displayedProjects.map((project, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className={`group relative bg-dark-900 rounded-2xl p-6 border border-gray-800 hover:border-primary-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/10 ${project.title === 'Chase MyHome Platform' ? 'lg:col-span-2' : ''}`}
            >
              {/* Tags */}
              ...
              <div className="space-y-4">
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="inline-flex items-center gap-2 text-primary-400 hover:text-primary-300 font-medium text-sm group/link transition-colors duration-200"
                >
